        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              '・広告配信のための匿名利用情報\n'
              '※お子様の名前、生年月日、マイルストーン記録（達成日、メモ、写真）などの入力情報は、本アプリ運営者に送信・収集されません（端末内のローカル保存のみ）。',
            ),
            _buildSection(
              '2. 情報の利用目的',
            ...
            _buildSection(
              '6. データの削除',
              'ユーザーは、アプリをアンインストールすることで、ローカルに保存されたすべてのデータを削除できます。データ削除に関するお問い合わせは、サポートメールまでご連絡ください。',
            ),
            _buildSection(
              '7. 子どものプライバシー',
